...
![Illustration of two atoms with a shared electron.](Part1/Support_Files/Atoms_Sharing_an_Electron.svg){:standalone}
...
![Illustration representing electricity concepts as a water tower.](Part2/Support_Files/Water_Tower_w_Units.svg){:standalone}
...
![Chart of alternating and direct current plotted against time.](Part3/Support_Files/AC_DC.svg){:standalone}
...
![Diagram of Ohm's Law Pyramid with Volts on top and Amps (I) and Ohms (R) splitting the base of the pyramid.](Part4/Support_Files/Ohms_Law_Pyramid.svg){:standalone}
...
![Circuit diagram of a source voltage and three resistors connected in series (end-to-end).](Part5/Support_Files/Kirchhoffs_Voltage_Law.svg){:standalone}
...
![Diagrams representing an OR logic gate and an AND logic gate.](Part6/Support_Files/Logical_AND_OR_Gates.svg){:standalone}